...
Route::delete('delete-account/{id}', [App\Http\Controllers\UserController::class, 'deleteAccount']);
...
Route::put('isdone-task/{id}', [App\Http\Controllers\TaskController::class, 'isDone']);
